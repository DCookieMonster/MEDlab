        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown messages-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope"></i> Messffages <span class="badge"><?php echo $result['num'];?></span> <b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="#">View Inbox <span class="badge"><?php echo $result;?></span></a></li>
              </ul>
            </li>
