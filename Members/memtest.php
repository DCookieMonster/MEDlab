       ...
       echo '        <div id="header">
            ...
            <div id="topbar">
                <div class="fl_left">
                 ...
                 ';echo'       <div>
                            <br/>
                          <input type="text" name="input"  value="Search the site&hellip;" onfocus="this.value=(this.value==';echo "'Search the site&hellip;'";
echo")? '' : this.value ;"." />";
    ...
    echo'    <div id="intro">
     ...
     <div class="container">
        ...
        <div class="row">
                  ...
                  echo'  <h2 class="page-header" style="font-size: 28px">'.$row['name'].'</h2>';
                  echo'  <div id="'.$row['tag'].'">';
                  echo'       <img  class="img-circle img-responsive pull-right"  src="'.$row['pic'].'">';
				echo $row['text'];
      			// close connection 
				mysql_close();
