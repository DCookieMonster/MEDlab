...
$rows=mysqli_fetch_array($db_con,$result);
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
         <div class="col-lg-12">
             <form name="form1" role="form" method="post" action="update_search.php">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="description" type="text" id="description"> <?php echo $rows['description']; ?></textarea>
                <p class="help-block">The description of the page.</p>
              </div>
              <div class="form-group">
                <label>Keywords</label>
                <textarea class="form-control" rows="3" name="keywords" type="text" id="keywords"> <?php echo $rows['keywords']; ?></textarea>
                <p class="help-block">Keywords for the search.</p>
              </div>
              <div class="form-group">
                <label>Link</label>
                <input class="form-control" name="link" type="text" id="link" value="<?php echo $rows['link']; ?>">
                <p class="help-block">The link to the page.</p>
              </div>
