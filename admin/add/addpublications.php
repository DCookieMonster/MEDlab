  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><i class="fa fa-pencil"></i> Publication</li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Add <small>to the publication database</small></h1>
            <ol class="breadcrumb">
              <li><a href="../add.php" ><i class="fa fa-plus"></i> Add</a></li>
        ...
        <div class="row">
         <div class="col-lg-12">
          ...
          <form action="add_func_pub.php" method="post">
                     <div class="form-group">
                <label>Name:</label>
                <input class="form-control" type="text" name="name" placeholder="Enter text">
              </div>    <div class="form-group">
                <label>Tag:</label>
                <input class="form-control" type="text" name="tag" placeholder="Enter text">
              </div> 
                  <div class="form-group">
                <label>Title:</label>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="abstract" placeholder="Enter text" rows="3"></textarea>
              </div>

                <div class="form-group">
                <label>link:</label>
                <input class="form-control" type="text" name="link" placeholder="Enter text">
              </div>
