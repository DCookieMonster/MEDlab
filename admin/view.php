...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="view.php"><i class="fa fa-table"></i> View Data</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>View <small>all database</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-table"></i> View Data</li>
            </ol>
            <div class="alert alert-success alert-dismissable">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              Welcome to the admin page! Here you choose which database you want to see.
            </div>
          </div>
        </div><!-- /.row -->
           ...
           <div class="row">
               <div class="col-lg-4">
                         <form action="view/viewSearch.php" method="post">
  ...
  <div class="panel panel-info" align="center">
              ...
              <div class="panel-body">
                View the "Search Engine" Database.<br><br>
    ...
    <div class="col-lg-4">
            <form action="view/viewPublications.php" method="post">
  <div class="panel panel-success" align="center">
              <div class="panel-heading">
                <h3 class="panel-title">Publications</h3>
              </div>
              <div class="panel-body">
                View the "Publications" Database.<br><br>
                <button type="submit" class="btn btn-primary">GO TO</button>
