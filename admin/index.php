...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin"  method="post" action="checklogin.php" role="form">
        <h2 class="form-signin-heading">Please sign in</h2>
        <input name="myusername" type="text" id="myusername" class="form-control" placeholder="Username" required autofocus>
